...
export async function issueLightningInvoice(
  ...
  try {
    ...
    console.log(`   Payment Request: ${mockInvoice.payment_request.substring(0, 25)}...`);
 ...
 */
function generateMockInvoice(amountBtc: number, memo?: string): LightningInvoice {
  ...
  const paymentRequest = `lnbc${amountSatoshis}`;
  
  return {
    payment_request: paymentRequest,
    r_hash: mockPaymentHash,
    add_index: "1",
    payment_addr: mockPaymentHash,
    value: amountSatoshis.toString(),
    cltv_expiry: "144",
    expiry: "3600",
    private: false,
